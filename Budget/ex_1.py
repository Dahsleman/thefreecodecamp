...
def create_spend_chart(categories:list) -> str:
    ...
    if not category_2 and category_3 and category_4:
        ...
        return f'{bolinha(percentual(category_1,category_2))}\n    -{vertically_category(category_1,category_2)}'

    elif category_4 == None:
        return f'{bolinha(percentual(category_1,category_2,category_3))}\n    -{vertically_category(category_1,category_2,category_3)}'

    else:
        return f'{bolinha(percentual(category_1,category_2,category_3,category_4))}\n    -{vertically_category(category_1,category_2,category_3,category_4)}'
